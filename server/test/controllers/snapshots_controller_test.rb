...
class SnapshotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snapshot" do
    assert_difference('Snapshot.count') do
      post snapshots_url, params: { snapshot: { answers: @snapshot.answers, comments: @snapshot.comments, location_id: @snapshot.location_id, questions: @snapshot.questions, sensors: @snapshot.sensors, timeinterval: @snapshot.timeinterval, timestamp: @snapshot.timestamp } }
    end
  ...
  test "should update snapshot" do
    patch snapshot_url(@snapshot), params: { snapshot: { answers: @snapshot.answers, comments: @snapshot.comments, location_id: @snapshot.location_id, questions: @snapshot.questions, sensors: @snapshot.sensors, timeinterval: @snapshot.timeinterval, timestamp: @snapshot.timestamp } }
