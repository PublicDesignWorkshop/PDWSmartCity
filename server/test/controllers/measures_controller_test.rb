...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { latitude: @measure.latitude, location_id: @measure.location_id, longitude: @measure.longitude, model: @measure.model, timestamp: @measure.timestamp, type: @measure.type, unit: @measure.unit, value: @measure.value } }
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { latitude: @measure.latitude, location_id: @measure.location_id, longitude: @measure.longitude, model: @measure.model, timestamp: @measure.timestamp, type: @measure.type, unit: @measure.unit, value: @measure.value } }
